...
\begin{itemize}[leftmargin=*,label={}]
  \BLOCK{for paper in archival_papers}
     ...
     \BLOCK{else}
       \item \hspace*{2em} \hyperlink{page.\VAR{paper.start_page}}{\emph{\VAR{paper.title}}}\\ \hspace*{2em} \VAR{join_names(", ", paper.authors, " and ")}\dotfill \hyperlink{page.\VAR{paper.start_page}}{\VAR{paper.start_page}}
     \BLOCK{endif}
  \BLOCK{endfor}
\end{itemize}
\newpage
